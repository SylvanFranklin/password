...
<div class="relative z-0">
    ...
    >
        ...
        >
            ...
            <span
                class="rounded-md p-2 bg-slate-200/10 flex flex-row items-center w-1/2 bg-blue overflow-hidden whitespace-nowrap h-full"
            >
        ...
        {#if hover}
            <button
                ...
                class="text-white scale-75 cursor-pointer hover:scale-90 duration-75 absolute -top-2 -left-2"
